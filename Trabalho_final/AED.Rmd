...
Como existe uma relação entre valor mensal pago e metodos de pagamentos, multiplas linhas,serviço de internet,etc(todos os componentes que são responsaveis pela fatura que é gerada por cada conta). Sabendo desta informação vamos ajustar dois possiveis modelos parametricos utilizando a log normal.
```{r}
